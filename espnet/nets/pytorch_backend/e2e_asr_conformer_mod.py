...
from espnet.nets.pytorch_backend.transformer.decoder_mod import Decoder
from espnet.nets.pytorch_backend.transformer.encoder import Encoder
from espnet.nets.pytorch_backend.transformer.label_smoothing_loss import LabelSmoothingLoss
from espnet.nets.pytorch_backend.transformer.mask import target_mask


class E2Emod(torch.nn.Module):
    def __init__(self, odim, new_odim, args, ignore_id=-1):
    ...
    def forward(self, x, lengths, label):
        ...
        # print(f"ys_in_pad: {ys_in_pad}")
        # print(f"ys_mask: {ys_mask}")
        # print(f"x: {x}")
